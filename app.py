...
def interpret_signs():
    ...
    prompt = (
        ...
        f"CRITICAL RULE: Do NOT explain, apologize, or add conversational filler. Only output the final translation. For any translated word or phrase, append a very short, simple definition in parentheses at the end of the translation (e.g., \"BAD (unpleasant or harmful)\" or \"STORE (a place where goods are sold)\"). Keep the definition inside the parentheses extremely concise (under 6 words). If the translation is a full sentence, append a brief summary of the action in parentheses (e.g., \"I will go to the store tomorrow. (future action of shopping)\"). If the translation is just a single letter (like \"B\"), do NOT append a definition. Additionally, if the input gloss appears to be spelling a word (e.g., \"B A D\") or forming an incomplete sentence (e.g., \"I WANT\"), predict and append 2-3 possible completions separated by a vertical bar '|' (e.g., \"BAD (unpleasant or harmful) | Predictions: BADGER, BADLY, BADMINTON\" or \"I want (desire) | Predictions: ... to eat, ... to go home\"). If there is nothing to predict, do not add the vertical bar or predictions.\n\n"
        f"Guidelines:\n"
